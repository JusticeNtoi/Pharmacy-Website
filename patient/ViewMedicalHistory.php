  ...
  <body>
    ...
    <nav>
      ...
      <ul class="nav-links">
        ...
        <li><a class="active" href="ViewMedicalHistory.php">Medical History</a></li>
...
<?php
  ...
  $sql = "SELECT * FROM orders where email = '$email' AND status = 'delivered'";
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr><th>Medicine_Names</th><th>Date</th><th>Price</th></tr>";
